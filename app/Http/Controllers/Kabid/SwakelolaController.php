...
{
    /**
     * Daftar paket swakelola untuk Kabid, dikelompokkan per jenis ruang eksekusi
     * (perjalanan dinas / lembur / lainnya, berdasarkan rekening belanja).
     */
    public function index(Request $request)
    {
        Gate::authorize('viewAny', Package::class);

        $ruangFilter = $request->input('ruang'); // perjalanan | lembur | lainnya
        ...
        // Statistik per jenis ruang + kesiapan ruang eksekusi (mengikuti pencarian)
        $stats = [
        ...
        return view('kabid.swakelola.index', compact('packages', 'stats', 'ruangFilter'));
    }
}
