...
<div class="space-y-6" x-data="stafTravelOrderCreate({
    ...
    initialStart: @js(old('tanggal_berangkat', $isEdit ? $travelOrder->tanggal_berangkat?->format('Y-m-d') : ($defaultDate ?? null))),
    initialEnd: @js(old('tanggal_kembali', $isEdit ? $travelOrder->tanggal_kembali?->format('Y-m-d') : ($defaultEndDate ?? null))),
