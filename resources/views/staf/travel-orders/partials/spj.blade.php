...
<div class="space-y-6"
    ...
    {{-- Bar navigasi mode SPJ (kembali ke detail tanpa pindah URL) --}}
    <div class="flex flex-wrap items-center justify-between gap-3">
        <button type="button" id="btn-back-detail"
    ...
    <form method="POST" id="spj-store-form" action="{{ route('staf.packages.travel-orders.spj.store', [$package, $travelOrder]) }}" class="space-y-4">
        @csrf
