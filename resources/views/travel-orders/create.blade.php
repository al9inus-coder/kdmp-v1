...
<div class="row">
    <div class="col-md-12">
        <form action="{{ route('packages.travel-orders.store', $package) }}" method="POST" id="travelOrderForm">
            @csrf
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-8 mb-3" id="tempat_tujuan_container">
                            ...
                            <select name="tempat_tujuan" id="tempat_tujuan" class="form-control" required>
                                <!-- Populated by JS -->
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="date" name="tanggal_berangkat" class="form-control" value="{{ old('tanggal_berangkat') }}" required>
                        </div>
                        <div class="col-md-4 mb-3">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <textarea name="dasar_pelaksanaan" class="form-control" rows="3">{{ old('dasar_pelaksanaan') }}</textarea>
                        </div>
                        <div class="col-md-6 mb-3">
            ...
            <div class="card mt-3">
                ...
                <div class="card-footer">
                    <button type="submit" class="btn btn-primary" id="btnSubmit">Simpan & Buat Surat</button>
                    <a href="{{ route('procurement-packages.show', $package) }}" class="btn btn-secondary">Batal</a>
                </div>
            </div>
        </form>
    </div>
