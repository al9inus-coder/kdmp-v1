            ...
            <form action="{{ route('employees.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <select name="kategori_biaya" class="form-control @error('kategori_biaya') is-invalid @enderror">
                        ...
                        <option value="Eselon II" {{ old('kategori_biaya') == 'Eselon II' ? 'selected' : '' }}>Eselon II</option>
                        <option value="Eselon III, Gol. IV dan Jafung Madya" {{ old('kategori_biaya') == 'Eselon III, Gol. IV dan Jafung Madya' ? 'selected' : '' }}>Eselon III, Gol. IV dan Jafung Madya</option>
                        <option value="Eselon IV, Gol. III kebawah, P3K, Jafung, Non ASN" {{ old('kategori_biaya') == 'Eselon IV, Gol. III kebawah, P3K, Jafung, Non ASN' ? 'selected' : '' }}>Eselon IV, Gol. III kebawah, P3K, Jafung, Non ASN</option>
                    </select>
