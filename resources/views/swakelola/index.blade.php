...
<x-ui.workspace title="Daftar Swakelola" description="Paket pengadaan dengan jenis Swakelola.">
    <x-slot:actions>
    ...
    <x-ui.card padding="none" class="mb-6">
        <form method="GET" action="{{ route('swakelola.index') }}" class="p-4 flex flex-col sm:flex-row gap-3">
            ...
            <div class="flex items-center gap-2">
                ...
                <a href="{{ route('swakelola.index') }}" class="inline-flex items-center gap-2 px-4 py-2.5 text-sm font-semibold text-slate-600 bg-white border border-slate-200 rounded-xl hover:bg-slate-50 transition-colors">
