...
<div class="max-w-3xl">
    ...
    <div class="flex flex-wrap items-center justify-between gap-3 mt-6">
        <x-ui.button variant="secondary" size="md" href="{{ route((auth()->user()->hasRole(['Admin', 'Super Admin']) ? 'admin.' : 'kabid.') . 'procurement-packages.price-references.index', $procurementPackage->package) }}">
