...
<x-ui.workspace title="SBU Transportasi" description="Standar biaya transportasi darat berdasarkan tempat tujuan.">
    <x-slot:actions>
        ...
        <x-ui.button variant="primary" size="md" href="{{ route('sbu-transport-rates.create') }}">
                        ...
                        <tr class="hover:bg-slate-50/80 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center justify-center gap-1.5">
                                    <a href="{{ route('sbu-transport-rates.edit', $rate) }}"
                                    ...
                                    <form action="{{ route('sbu-transport-rates.destroy', $rate) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus data ini?');">
                                        @csrf
                                        @method('DELETE')
