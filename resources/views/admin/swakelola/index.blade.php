...
@php
    $rolePrefix = 'admin';
    $routeShow = 'admin.procurement-packages.show';
    ...
    $ruangUrl = fn($r) => route($rolePrefix . '.swakelola.index', array_filter([
        'ruang'  => $r,
...
<x-ui.workspace title="Daftar Swakelola" description="Paket pengadaan jenis Swakelola — klik kartu jenis ruang untuk memfilter.">
    ...
    <x-ui.card padding="none" class="mb-6">
        <form method="GET" action="{{ route($rolePrefix . '.swakelola.index') }}" class="p-4 flex flex-col sm:flex-row gap-3">
            @if($ruangFilter)
            ...
            <div class="flex items-center gap-2">
                ...
                <a href="{{ route($rolePrefix . '.swakelola.index') }}" class="inline-flex items-center gap-2 px-4 py-2.5 text-sm font-semibold text-slate-600 bg-white border border-slate-200 rounded-xl hover:bg-slate-50 transition-colors">
            ...
            <table class="w-full text-sm text-left">
                ...
                <tbody class="divide-y divide-slate-100">
                    @forelse($packages as $package)
                        <tr class="hover:bg-slate-50/80 transition-colors group cursor-pointer" onclick="window.location.href='{{ route($routeShow, $package) }}'">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center justify-center">
                                    <a href="{{ route($routeShow, $package) }}" onclick="event.stopPropagation()"
