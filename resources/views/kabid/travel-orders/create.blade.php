...
@section('title', isset($travelOrder) ? 'Edit Perjalanan Dinas' : 'Buat Perjalanan Dinas')

@php
    $isEdit = isset($travelOrder);
    $pageTitle = $isEdit ? 'Edit Perjalanan Dinas' : 'Buat Perjalanan Dinas';
...
<div class="space-y-6" x-data="kabidTravelOrderCreate({
    ...
    <div class="flex flex-wrap items-center justify-between gap-3">
        ...
        <a href="{{ $isEdit ? route('kabid.packages.travel-orders.show', [$package, $travelOrder]) : route('kabid.procurement-packages.show', $package) }}"
    ...
    <form method="POST" action="{{ $isEdit ? route('kabid.packages.travel-orders.update', [$package, $travelOrder]) : route('kabid.packages.travel-orders.store', $package) }}"
...
<script>
    function kabidTravelOrderCreate(config) {
