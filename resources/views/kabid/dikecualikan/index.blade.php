...
@php
    ...
    $jenisUrl = fn($j) => route('kabid.dikecualikan.index', array_filter([
        'jenis'  => $j,
...
<x-ui.workspace title="Pengadaan Dikecualikan" description="Pengadaan tanpa tahapan workflow — klik kartu jenis untuk memfilter, pantau kelengkapan dokumen & realisasi.">
    ...
    <x-ui.card padding="none" class="mb-6">
        <form method="GET" action="{{ route('kabid.dikecualikan.index') }}" class="p-4 flex flex-col sm:flex-row gap-3">
            @if($typeFilter)
            ...
            <div class="flex items-center gap-2">
                ...
                <a href="{{ route('kabid.dikecualikan.index') }}" class="inline-flex items-center gap-2 px-4 py-2.5 text-sm font-semibold text-slate-600 bg-white border border-slate-200 rounded-xl hover:bg-slate-50 transition-colors">
                        ...
                        <tr class="hover:bg-slate-50/80 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center justify-center">
                                    <a href="{{ route('kabid.procurement-packages.show', $pkg) }}"
