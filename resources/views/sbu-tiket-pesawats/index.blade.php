...
<x-ui.workspace title="SBU Tiket Pesawat" description="Standar biaya tiket pesawat berdasarkan tujuan.">
    <x-slot:actions>
        ...
        <x-ui.button variant="primary" size="md" href="{{ route('admin.sbu-tiket-pesawats.create') }}">
                        ...
                        <tr class="hover:bg-slate-50/80 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center justify-center gap-1.5">
                                    <a href="{{ route('admin.sbu-tiket-pesawats.edit', $rate) }}"
                                    ...
                                    <form action="{{ route('admin.sbu-tiket-pesawats.destroy', $rate) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus data ini?');">
                                        @csrf
                                        @method('DELETE')
